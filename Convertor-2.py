...
def exit ():
    close =messagebox.askyesno('Exit?')
    if close > 0 :
        a.destroy()
...
bit1 = Button (text='convert',command=dec_convertor,fg='black',bg='sky blue', cursor='heart',width=10, height=2,font=('Arial', 18))
bit1.grid(row=0, column=4)
bit2 = Button (text='convert',command=bin_convertor ,fg='black',bg='sky blue', cursor='heart',width=10, height=2,font=('Arial', 18))
bit2.grid(row=1, column=4)
bit3 = Button (text='convert',command=oct_convertor,fg='black',bg='sky blue', cursor='heart',width=10, height=2,font=('Arial', 18))
bit3.grid(row=2, column=4)
bit4 = Button (text='convert',command=hexa_convertor,fg='black',bg='sky blue', cursor='heart',width=10, height=2,font=('Arial', 18))
bit4.grid(row=3, column=4)

bit5 = Button(text='Exit',command=exit, fg='black', bg='sky blue', cursor='heart', width=10, height=2, font=('Arial', 18))
bit5.grid(row=6, column=2)
bit6 = Button( text='Clear',command=clear, fg='black', bg='sky blue', cursor='heart', width=10, height=2, font=('Arial', 18))
bit6.grid(row=5, column=2)

lab1 = Label(text='Decimal',fg='black',bg='sky blue',width=10, height=2,font=('Arial', 18))
lab1.grid(row=0, column=0)
lab2 = Label(text='Binary',fg='black',bg='sky blue',width=10, height=2,font=('Arial', 18))
lab2.grid(row=1, column=0)
lab3 = Label(text='Octal',fg='black',bg='sky blue',width=10, height=2,font=('Arial', 18))
lab3.grid(row=2, column=0)
lab4 = Label(text='Hexadecimal',fg='black',bg='sky blue',width=10, height=2,font=('Arial', 18))
